...
INSERT INTO `items` VALUES (1,'Cheese Burger','FD-101',5,1500,1),(2,'Sandwich','FD-102',1,450,1),(3,'Coca-Cola','DK-101',3,100,2),(4,'Soda','DK-102',14,300,2),(5,'Hot Dog','FD-103',4,300,1),(6,'Pesi-Cola','DK-103',15,600,2),(7,'Pancil','SN-101',5,300,4),(8,'Note Book','SN-102',7,600,4),(9,'Ball Pen','SN-105',0,300,4);
...
INSERT INTO `users` VALUES (1,'Wai Lwin Phyo','admin','admin','1'),(2,'Aye Aye','ayeaye','aye','2'),(3,'Aung Aung','aungaung','aung','2'),(5,'Kyaw Kyaw','kyawkyaw','kyaw','2');
...
-- Dump completed on 2019-09-04  2:09:20
